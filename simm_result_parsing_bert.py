...
def parse_name(name):
  ...
  elif 'batchnorm' in name or 'batch_norm' in name or 'dropout' in name:
    return 'Fusion(LayerNorm+Dropout)'
  # elif 'cast' in name:
  #   return 'Fusion(Cast)'
  ...
  #   return 'Fusion(ReLU)'
    ...
    return 'Fusion(softmax)'
  elif 'softmax' in name or 'dropout' in name:
    return 'Fusion(dropout+softmax)'
